class Cafe24AppCalendarPrdView extends HTMLElement {
  constructor() {
    super();
  ...
  async render() {
    ...
    const template = CAC_UTIL.isMobile()
      ? document.getElementById('calendar-app-template-prd-view-mo').content
      : document.getElementById('calendar-app-template-prd-view-pc').content;
