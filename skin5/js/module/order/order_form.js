...
function viewMallAgree() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/agreement/mallagree.html?basket_type='+$('#basket_type').val()+'&delvtype='+getQueryString('delvtype'), '', 'width=450,height=350');
    }
}
//비회원 구매시 개인정보수집이용동의
function viewPersonAgree() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/agreement/personagree.html?basket_type='+$('#basket_type').val()+'&delvtype='+getQueryString('delvtype'), '', 'width=450,height=350');
    }
}
//청약철회방침 보기
function viewSubscription() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/agreement/subscription.html?basket_type='+$('#basket_type').val(), '', 'width=450,height=350');
    }
}
//전자보증보험 보기
function viewInsurance() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/agreement/insurance.html?basket_type='+$('#basket_type').val() +'&delvtype='+getQueryString('delvtype'), '', 'width=450,height=350');
    }
}
//Daum 비회원 구매 동의 보기
function viewDaum() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/agreement/daum.html?basket_type='+$('#basket_type').val(), '', 'width=450,height=350');
    }
}
//배송정보 제공방침 동의
function viewDelivery() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/agreement/delivery.html?basket_type='+$('#basket_type').val()+'&delvtype='+getQueryString('delvtype'), '', 'width=450,height=350');
    }
}
//고유식별정보수집 동의
function viewIdentification() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/agreement/identification.html?basket_type='+$('#basket_type').val()+'&delvtype='+getQueryString('delvtype'), '', 'width=450,height=350');
    }
}
//개인정보수집 이용동의
function viewMemberJoinAgree() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/agreement/privacy_agreement.html?basket_type='+$('#basket_type').val()+'&delvtype='+getQueryString('delvtype'), '', 'width=450,height=350');
    }
}
//개인정보 제3자 제공 동의
function viewInformationAgree() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/agreement/information_agreement.html?basket_type='+$('#basket_type').val()+'&delvtype='+getQueryString('delvtype'), '', 'width=450,height=350');
    }
}
//개인정보취급 위탁 동의
function viewConsignmentAgree() {
    if (EC_MOBILE_DEVICE == true) {
        ...
        window.open('/order/agreement/consignment_agreement.html?basket_type='+$('#basket_type').val()+'&delvtype='+getQueryString('delvtype'), '', 'width=450,height=350');
    }
}
//장바구니 선택상품 삭제
