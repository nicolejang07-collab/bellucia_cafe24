class Cafe24AppCalendarImgView extends HTMLElement {
  constructor() {
    super();
  ...
  async render() {
    ...
    const template = CAC_UTIL.isMobile()
      ? document.getElementById('calendar-app-template-img-view-mo').content
      : document.getElementById('calendar-app-template-img-view-pc').content;
